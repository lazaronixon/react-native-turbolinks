...
RCT_EXTERN_METHOD(replaceTabWith:(NSDictionary *) tabIndex:(NSInteger *))
...
RCT_EXTERN_METHOD(renderTabTitle:(NSString *) subtitle:(NSString *) tabIndex:(NSInteger *))
RCT_EXTERN_METHOD(renderActions:(NSArray *))
RCT_EXTERN_METHOD(renderTabActions:(NSArray *) tabIndex:(NSInteger *))
